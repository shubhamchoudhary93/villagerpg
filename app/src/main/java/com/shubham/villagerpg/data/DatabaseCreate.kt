...
object DatabaseCreate {
    ...
    fun createFirst(context: Context) {
        ...
        questDatabase.insert(Quest(0, "Quest 1", "Wood", 5, "", 0, 0))
        questDatabase.insert(Quest(0, "Quest 1", "Iron", 5, "", 0, 0))
        questDatabase.insert(Quest(0, "Quest 2", "Wood", 10, "", 0, 0))
        questDatabase.insert(Quest(0, "Quest 2", "Iron", 10, "", 0, 0))
